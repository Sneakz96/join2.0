##  NEXT  
    ...
    -CHANGE STATUS ON SELECTED CONTACT 

    -NG_DEEP BUG ON OVERLAYS
    -BOARD BUG?
    -LOADING FROM FB BUG?
...
### DONE ###
    ...
    -CONTACT OVERLAYS OVERFLOW X
    -CONTACT LIST RESPONSIVE -> ROUTER LINK ? OPEN DIALOG
    -CONTACTS RESPONSIVE -> BOOLEAN ON CONTAINER 
    -CONTACTS NOT CLICKABLE
    -MB-MENU BUG   
